...
# Pass 5 - final remaining Spanish phrases
translations = [
    (r'// Si está vacío usa', '// If empty uses'),
    (r'// Directorio de extracción: tools\\mcp-nombre\\',
     '// Extraction directory: tools\\mcp-name\\'),
    (r'// Wait más datos o buffer vacío',
     '// Wait for more data or empty buffer'),
    ...
    (r'// ConfigFile si está asignado, sino',
     '// ConfigFile if assigned, otherwise'),
    (r'// está vacío', '// is empty'),
    (r'// está asignado', '// is assigned'),
...
print(f"=== Translation Summary (Pass 5) ===")
